...
public class PrologDateUtils {
	 ...
	 * @throws Exception
	 */
	public static Timestamp parseObject(Object o) throws Exception {
	...
	public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException{
		...
		if(!includeTime){
			SimpleDateFormat sdf = new SimpleDateFormat(PrologDateUtils.DATE_PATTERN);
	...
	public static String dateFormat(Date date, String pattern) throws ParseException{
		if(StringUtils.isEmpty(pattern)){
			pattern = PrologDateUtils.DATE_PATTERN;
		}
	...
	public static String dateTimeToDateString(Date dateTime) throws ParseException{
		String dateTimeString = PrologDateUtils.dateFormat(dateTime, PrologDateUtils.DATE_TIME_PATTERN);  
	 ...
	 * @throws Exception
	 */
	public static long getIntervals4TimeToNow(Date date) {
	 ...
	 * @return
	 */
	public static Double getBetweenHour(Date startTime, Date endTime) throws Exception {
		...
		return (endTimes - startTimes)*1.0/hour;
	}
}
